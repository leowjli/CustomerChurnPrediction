...
xgboost_model = load_model('assets/xgb_model.pkl')

naive_bayes_model = load_model('assets/nb_model.pkl')

random_forest_model = load_model('assets/rf_model.pkl')

decision_tree_model = load_model('assets/dt_model.pkl')

svm_model = load_model('assets/svm_model.pkl')

knn_model = load_model('assets/knn_model.pkl')

voting_classifier_model = load_model('assets/voting_clf.pkl')

xgboost_SMOTE_model = load_model('assets/xgboost-SMOTE.pkl')

xgboost_featureEngineered_model = load_model(
    'assets/xgboost-featureEngineered.pkl')
...
def make_prediction(input_df, input_dict):
    ...
    with col1:
        ...
        st.write(
            f"The customer has a {avg_probability: .2%} proability of churning."
        )
...
def explain_prediction(probability, input_dict, surname):
    prompt = f"""You are an expert data scienctist at a bank, where you specialize in interpreting and explaining predictions of machine learning models. 
...
def generate_email(probability, input_dict, explanation, surname):
  ...
  Here are some explanation as to why the customer might be at risk of churning:
  {explanation}
